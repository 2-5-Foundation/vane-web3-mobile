...
export interface InitOutput {
  ...
  readonly publicinterfaceworkerjs_initiateTransaction: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly publicinterfaceworkerjs_senderConfirm: (
    a: number,
    b: number,
    c: number,
    d: any,
  ...
  readonly publicinterfaceworkerjs_unsubscribeWatchTxUpdates: (
    a: number,
  ) => [number, number];
  readonly publicinterfaceworkerjs_watchP2pNotifications: (
    a: number,
    b: any,
  ) => any;
  readonly publicinterfaceworkerjs_unsubscribeWatchP2pNotifications: (
    a: number,
  ) => [number, number];
  readonly publicinterfaceworkerjs_fetchPendingTxUpdates: (
    a: number,
    b: number,
    c: number,
  ) => any;
  readonly publicinterfaceworkerjs_addAccount: (
    a: number,
    b: number,
    c: number,
    d: any,
  ) => any;
  readonly publicinterfaceworkerjs_receiverConfirm: (
    a: number,
    b: number,
    c: number,
    d: any,
  ) => any;
  readonly publicinterfaceworkerjs_verifyTxCallPayload: (
    a: number,
    b: any,
  ) => any;
  readonly publicinterfaceworkerjs_revertTransaction: (
    a: number,
    b: number,
    c: number,
    d: any,
  ...
  readonly publicinterfaceworkerjs_deleteTxInCache: (
    a: number,
    b: any,
  ) => [number, number];
  readonly publicinterfaceworkerjs_clearRevertedFromCache: (
    a: number,
  ) => [number, number];
  readonly publicinterfaceworkerjs_clearFinalizedFromCache: (
    a: number,
  ) => [number, number];
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1a79a3c1169870fb: (
    a: number,
    b: number,
  ) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hff5c85c2ca770dbc: (
    a: number,
    b: number,
  ) => void;
  readonly closure731_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7876d40aeac1bca2: (
    a: number,
    b: number,
  ) => void;
  readonly closure812_externref_shim: (
    a: number,
    b: number,
    c: any,
    d: any,
