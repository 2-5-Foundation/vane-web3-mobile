 ...
 */
export function start_vane_web3(
  sig,
  ...
  const ret = wasm.start_vane_web3(
    ptr0,
    len0,
    ptr1,
    len1,
...
function __wbg_adapter_59(arg0, arg1) {
  wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1a79a3c1169870fb(
    arg0,
    arg1,
  );
}
...
function __wbg_adapter_64(arg0, arg1) {
  wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hff5c85c2ca770dbc(
    arg0,
    arg1,
  );
}
...
function __wbg_adapter_70(arg0, arg1) {
  wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7876d40aeac1bca2(
    arg0,
    arg1,
  );
}
...
const PublicInterfaceWorkerJsFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_publicinterfaceworkerjs_free(ptr >>> 0, 1),
      );
...
export class PublicInterfaceWorkerJs {
  ...
  initiateTransaction(
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.publicinterfaceworkerjs_initiateTransaction(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  senderConfirm(sig, tx) {
    const ptr0 = passArray8ToWasm0(sig, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.publicinterfaceworkerjs_senderConfirm(
      this.__wbg_ptr,
      ptr0,
      len0,
      tx,
  ...
  watchTxUpdates(callback) {
    const ret = wasm.publicinterfaceworkerjs_watchTxUpdates(
      this.__wbg_ptr,
      callback,
    );
    return ret;
  ...
  unsubscribeWatchTxUpdates() {
    const ret = wasm.publicinterfaceworkerjs_unsubscribeWatchTxUpdates(
      this.__wbg_ptr,
    );
    if (ret[1]) {
  ...
  watchP2pNotifications(callback) {
    const ret = wasm.publicinterfaceworkerjs_watchP2pNotifications(
      this.__wbg_ptr,
      callback,
    );
    return ret;
  ...
  unsubscribeWatchP2pNotifications() {
    const ret = wasm.publicinterfaceworkerjs_unsubscribeWatchP2pNotifications(
      this.__wbg_ptr,
    );
    if (ret[1]) {
      throw takeFromExternrefTable0(ret[0]);
  ...
  fetchPendingTxUpdates(sig) {
    const ptr0 = passArray8ToWasm0(sig, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.publicinterfaceworkerjs_fetchPendingTxUpdates(
      this.__wbg_ptr,
      ptr0,
      len0,
    );
  ...
  addAccount(account_id, network) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.publicinterfaceworkerjs_addAccount(
      this.__wbg_ptr,
      ptr0,
      len0,
      network,
  ...
  receiverConfirm(sig, tx) {
    const ptr0 = passArray8ToWasm0(sig, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.publicinterfaceworkerjs_receiverConfirm(
      this.__wbg_ptr,
      ptr0,
      len0,
      tx,
  ...
  verifyTxCallPayload(tx) {
    const ret = wasm.publicinterfaceworkerjs_verifyTxCallPayload(
      this.__wbg_ptr,
      tx,
    );
    return ret;
  ...
  revertTransaction(sig, tx, reason) {
    ...
    const ret = wasm.publicinterfaceworkerjs_revertTransaction(
      this.__wbg_ptr,
      ptr0,
      len0,
      tx,
   ...
   */
  deleteTxInCache(tx) {
    const ret = wasm.publicinterfaceworkerjs_deleteTxInCache(
      this.__wbg_ptr,
      tx,
    );
    if (ret[1]) {
  ...
  clearRevertedFromCache() {
    const ret = wasm.publicinterfaceworkerjs_clearRevertedFromCache(
      this.__wbg_ptr,
    );
    if (ret[1]) {
      throw takeFromExternrefTable0(ret[0]);
  ...
  clearFinalizedFromCache() {
    const ret = wasm.publicinterfaceworkerjs_clearFinalizedFromCache(
      this.__wbg_ptr,
    );
    if (ret[1]) {
      throw takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
  ...
  imports.wbg.__wbg_dispatchEvent_9e259d7c1d603dfb = function () {
    return handleError(function (arg0, arg1) {
  ...
  imports.wbg.__wbg_log_0ee642605deb699c = function (
    arg0,
    arg1,
    arg2,
    arg3,
    ...
    hostFunctions.hostLogging.log(
      ...
      arg5 === 0 ? undefined : getStringFromWasm0(arg5, arg6),
      arg7 === 0 ? undefined : getStringFromWasm0(arg7, arg8),
      arg9 === 0x100000001 ? undefined : arg9,
    );
  };
  ...
  imports.wbg.__wbg_newwitheventinitdict_502dbfa1b3d2fcbc = function () {
    return handleError(function (arg0, arg1, arg2) {
  ...
  imports.wbg.__wbg_submitTx_8c54c1bcece2ab07 = function () {
    return handleError(function (arg0) {
